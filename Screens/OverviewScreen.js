...
//                            title={data.name} />;
    ...
    return (
            <View style={styles.container}>
             ...
             <View style={styles.titlePlanif}>
                            <Text style={styles.text}>Liste des journées planifiées</Text>
                        </View>

                        <View style={styles.suggest}>
                            <Text>Jorney {/*places.title*/}</Text>
                        </View>
              ...
              <MapView onLongPress={() => navigation.navigate('Map')} mapType="hybrid" style={styles.map}>
